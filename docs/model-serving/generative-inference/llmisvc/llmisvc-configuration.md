...
The merge process follows these steps (see [config_merge.go:77-163](https://github.com/kserve/kserve/blob/main/pkg/controller/llmisvc/config_merge.go#L77-L163)):
...
(see [config_merge.go:266-281](https://github.com/kserve/kserve/blob/main/pkg/controller/llmisvc/config_merge.go#L266-L281)):
...
- Uses Kubernetes `strategicpatch.StrategicMergePatch` ([config_merge.go:302-348](https://github.com/kserve/kserve/blob/main/pkg/controller/llmisvc/config_merge.go#L302-L348))
...
spec:
  model:
    ...
    criticality: High                            # Scheduling priority
```
...
| **`criticality`** | string | Scheduling priority for Inference Gateway | `High`, `Medium`, `Low` |


**Use case**: Low-Rank Adaptation for model customization without retraining.
...
**Learn more**: [Architecture Guide - Prefill-Decode Separation](./llmisvc-architecture.md#prefill-decode-separation)
...
**Learn more**: [Architecture Guide - Gateway](./llmisvc-architecture.md#gateway-architecture)
...
**Learn more**: [Architecture Guide - Scheduler Architecture](./llmisvc-architecture.md#scheduler-architecture)
...
- **[Getting Started](../../../getting-started/genai-first-llmisvc.md)**: Deploy your first service
