...
**What KServe creates** (see [router.go:expectedGateway](https://github.com/kserve/kserve/blob/main/pkg/controller/llmisvc/router.go)):
...
**What KServe creates** (see [router.go:expectedHTTPRoute](https://github.com/kserve/kserve/blob/main/pkg/controller/llmisvc/router.go)):
...
- **[Getting Started](../../../getting-started/genai-first-llmisvc.md)**: Deploy examples
