...
### 🚀 Getting Started
- **[Quick Start Guide](../../../getting-started/genai-first-llmisvc.md)**: Deploy your first LLM service
- **[Deployment Patterns](../../../getting-started/genai-first-llmisvc.md#deployment-patterns-overview)**: Single-node, multi-node, prefill-decode, DP+EP
...
1. **Understand Dependencies**: Read [LLMInferenceService Dependencies](./llmisvc-dependencies.md) to ensure required components are installed
2. **Review Configuration**: Explore [Configuration Guide](./llmisvc-configuration.md) for detailed spec reference
3. **Study Architecture**: Learn [Architecture Patterns](./llmisvc-architecture.md) for system design
4. **Try Quick Start**: Follow [Getting Started Guide](../../../getting-started/genai-first-llmisvc.md) to deploy your first service
